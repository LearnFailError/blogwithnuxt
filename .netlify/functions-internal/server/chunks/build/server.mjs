import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineComponent, ref, inject, h, Suspense, hasInjectionContext, getCurrentInstance, Fragment, toRef, provide, shallowReactive, defineAsyncComponent, computed, unref, shallowRef, createApp, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, mergeProps, getCurrentScope, withCtx, nextTick, isReadonly, useSSRContext, isRef, isShallow, isReactive, toRaw } from 'vue';
import { e as createError$1, t as parseURL, k as encodePath, v as decodePath, x as hasProtocol, y as isScriptProtocol, z as joinURL, w as withQuery, A as sanitizeStatusCode, B as getContext, $ as $fetch, C as defu, D as createHooks, E as executeAsync, i as getHeader, s as setCookie, F as klona, G as getRequestHeader, H as destr, I as isEqual, J as getCookie, K as deleteCookie } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-B-bnXWFA.mjs')
  },
  {
    name: "blog-slug",
    path: "/blog/:slug()",
    component: () => import('./_slug_-C3EkWRd5.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-Cosg0KFK.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-KD7xa1K9.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-UmBzytSq.mjs'));
...
export { _export_sfc as _, useNuxtApp as a, asyncDataDefaults as b, createError as c, useRequestFetch as d, entry_default as default, __nuxt_component_0 as e, fetchDefaults as f, useRouter as g, encodeRoutePath as h, useRuntimeConfig as i, nuxtLinkDefaults as j, navigateTo as n, resolveRouteObject as r, showError as s, tryUseNuxtApp as t, useRoute as u };
